const NAV_ITEMS = [
  {
    id: 'dashboard', label: 'My Dashboard', href: 'worker-dashboard.html',
  ...
  {
    id: 'timeinout', label: 'Time In/Out', href: 'worker-timeinout.html',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>`
  },
  {
    id: 'tasks', label: 'My Tasks', href: 'worker-tasks.html',
  ...
  {
    id: 'attendance', label: 'My Attendance', href: 'worker-attendance.html',
    icon: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2" ry="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>`
  },
  {
    id: 'inventory', label: 'Inventory', href: 'worker-inventory.html',
  ...
  {
    id: 'elearning', label: 'E-Learning', href: 'worker-elearning.html',
  ...
  document.getElementById('app').innerHTML = `
    <div class="app-shell">
      <aside class="sidebar" id="sidebar">
        <a href="worker-dashboard.html" class="sidebar-brand">
      ...
      <div class="main-area">
        <header class="top-header">
          <p class="header-welcome">Welcome back, <span>Juan Dela Cruz</span></p>
